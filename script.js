document.addEventListener("DOMContentLoaded", function () {
    ...
    document.getElementById("startButton").addEventListener("click", function () {
        ...
        content.innerHTML = `
            <div class="envelope-wrapper">
                <div id="envelope" class="close">
                    ...
                    <div class="letter">
                        <p class="words line1">Hi Lovey! I'm so lucky to have you in my life :D</p>
		...
		btnContinue.addEventListener("click", function () {
			content.innerHTML = `
				<img src="https://media.tenor.com/efbi1EpFlVUAAAAi/bugcat-capoo.gif" alt="asking tonton">
				<div class="question">
					<p style="font-size: 24px;">Will you be my Valentine Rea Pot?</p>
			...
			document.getElementById("yesBtn").addEventListener("click", function () {
				content.innerHTML = `
					<div style="text-align: center;">
						<img src="https://media.tenor.com/YTw87WdiaasAAAAi/tkthao219-capoo.gif" alt="Love GIF" style="display: block; margin: 0 auto;">
			...
			// Fix: Add event listener for "No" button
			let messages = ["Please?", "Are you sure?", "Think again :(", "Last chance!", "I guess you have no choice..."];
			let messageIndex = 0;
